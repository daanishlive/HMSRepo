    ...
    public partial class AddedUSer : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.AcomodationPackages", t => t.AccomodationPackageID, cascadeDelete: true)
                .Index(t => t.AccomodationPackageID);
            
            CreateTable(
                "dbo.AcomodationPackages",
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                ...
                c => new
                    {
                        ...
                        FromDate = c.Decimal(nullable: false, precision: 18, scale: 2),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Accomodations", "AccomodationPackageID", "dbo.AcomodationPackages");
            DropForeignKey("dbo.AcomodationPackages", "AcomodationType_ID", "dbo.AcomodationTypes");
            ...
            DropIndex("dbo.AcomodationPackages", new[] { "AcomodationType_ID" });
            ...
            DropTable("dbo.AcomodationTypes");
            DropTable("dbo.AcomodationPackages");
